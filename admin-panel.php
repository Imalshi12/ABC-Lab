...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    ...
    <label> Test Result: </label>'.$row["testresult"].'<br/><br/>
...
<html lang="en">
 ...
 <body>
    <h3 style = "margin-left: 40%; margin-top:70px;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif, font-size: 10px;"> Welcome &nbsp<?php echo $username ?> 
   </h3>
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Test Result / Payment</a>
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <img src="images/lab_12528352.png" width="70px" height="70px" alt=""> </span>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <img src="images/calendar_3483794.png" width="70px" height="70px" alt=""> </span>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <img src="images/test-result_15101854.png" width="80px" height="70px" alt=""> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Test Result / Payment</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#list-pres" onclick="clickDiv('#list-pres-list')">
                          View Test Result and Payment
                        </a>
                      </p>
                    </div>
                  </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-4"><label for="doctor">Technisians:</label></div>
                <div class="col-md-8">
...
<!--Test Result/Payment -->
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select doctor,ID,appdate,apptime,disease,allergy,testresult from prestb where pid='$pid';";
                  ...
                  ?>
                      <tr>
                        ...
                        <td><a href="testresult.php">Download</a></td>
                        <td>
                          <form method="get">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="func.php">
          ...
          <input type="text" name="name" placeholder="Enter technisian name" class="form-control">
          <br>
          <input type="submit" name="doc_sub" value="Add Technisian" class="btn btn-primary">
        </form>
      </div>
