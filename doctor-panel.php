               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <img src="images/appointment.png" width="70px" height="70px" alt="">  </span>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <img src="images/test.png" width="70px" height="70px" alt=""> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;"> Test Result</h4>
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <button class="btn btn-success">Test Result</button></a>
                        <?php } else {
        ...
        <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,fname,lname,ID,appdate,apptime,disease,allergy,testresult from prestb where doctor='$doctor';";
