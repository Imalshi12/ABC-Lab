...
if(isset($_POST['docsub1']))
{
  ...
  if($result)
    {
      echo "<script>alert('Technician removed successfully!');</script>";
  }
  else{
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa-solid fa-flask-vial" ></i> ABC LABORATORY</a>
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-doc" id="list-doc-list"  role="tab"    aria-controls="home" data-toggle="list">View Technicians</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list"  role="tab" data-toggle="list" aria-controls="home">Test Result List</a>
      <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list"  role="tab" data-toggle="list" aria-controls="home">Add Technician</a>
      <a class="list-group-item list-group-item-action" href="#list-settings1" id="list-ddoc-list"  role="tab" data-toggle="list" aria-controls="home">Delete Technician</a>
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x">  <img src="images/scientist.png" width="70px" height="70px" alt="">  </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Technician List</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">   <img src="images/surgery-room.png" width="70px" height="70px" alt=""> </span>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">  <img src="images/appointment.png" width="80px" height="80px" alt=""> </span>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">   <img src="images/medical-report.png" width="70px" height="70px" alt=""> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Test List</h4>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">  <img src="images/unauthorized-person.png" width="70px" height="70px" alt=""></span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Manage Technicians</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-adoc-list')">Add Technician</a>
                        &nbsp|
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
          <div class="col-md-4"><label>Technician Name:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Blood Glucose Test" name="spec">Blood Glucose Test</option>
                      <option value="Complete Blood Count"name="spec">Complete Blood Count</option>
                      <option value="Liver Function Tests (LFTs)" name="spec">Liver Function Tests (LFTs)</option>
                      <option value="Electrocardiogram (ECG/EKG)" name="spec">Electrocardiogram (ECG/EKG)</option>
                      <option value="Thyroid Function Tests (TFTs)" name="spec">Thyroid Function Tests (TFTs)</option>
                      <option value="Urinalysis" name="spec">Urinalysis</option>
                      <option value="X-ray" name="spec">X-ray</option>
                    </select>
                    </div><br><br>
          ...
          <input type="submit" name="docsub" value="Add Technician" class="btn btn-primary">
        </form>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub1" value="Delete Technician" class="btn btn-primary" onclick="confirm('do you really want to delete?')">
        </form>
      </div>
